...
def admin_view_AllSchools(request):
    ...
    return render(request,'sms/admin_view_allschools.html',context=mydict)
...
def registerSchool(request):
    ...
    if request.method != 'POST':
        return render(request, 'sms/add_school.html', context=context)
    ...
    return render(request, 'sms/add_school.html', context)
...
def school_detail(request, school_id):
    ...
    if request.method != 'POST':
        return render(request, 'sms/school_detail.html', context=context)
        ...
        if user_form.is_valid() and department_form.is_valid:
            ...
            # messages.success(request, 'Your account has been registered sucessfully! Please wait for the approval.')
            return redirect('school-detail', id=school_id)
        else:
            print('invalid form')
            print(user_form.errors)
    else:
    ...
    return render(request, 'sms/school_detail.html', context)
